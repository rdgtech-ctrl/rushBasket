...
const Signup = () => {
  ...
  useEffect(() => {
    if (showToast) {
      ...
      // Timer starts (counting: 1... 2 seconds...)
      // User closes app before 2 seconds
      // App is gone ❌
      // But timer still counting 🔄
      // After 2 seconds, timer tries to do something
      // But app doesn't exist anymore!
      // Wasted memory ❌
  ...
  const handleChange = (e) => {
    ...
    //This clears the error message when user starts typing.
  }

  // VALIDATING ALL FILES ARE FILLED OR NOT
  const validate = () => {
    const newErrors = {};
      ...
      <div className={signupStyles.signupCard}>
        ...
        <form onSubmit={handleSubmit} className={signupStyles.form}>
          ...
          <div className={signupStyles.inputContainer}>
            ...
            <button type='button' onClick={() => togglePasswordVisibility('password')} className={signupStyles.toggleButton} aria-label={showPassword.password ? 'Hide password' : 'Show password'}>
