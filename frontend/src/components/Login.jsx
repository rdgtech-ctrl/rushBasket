...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        window.dispatchEvent(new Event('authStateChanged'))
            ↓
        All components listening catch it
            ↓
        Update UI (show logout button, etc.)
        */
        setTimeout(() => {
            navigate('/')
        })
            ...
            <div className={loginStyles.loginCard}>
                ...
                <form onSubmit={handleSubmit} className={loginStyles.form}>
                    ...
                    <div className={loginStyles.inputContainer}>
                        ...
                        <input type="email" name='email' value={formData.email} onChange={handleChange} placeholder='Email Address' required className={loginStyles.input} />
                    </div>

                    <div className={loginStyles.inputContainer}>
                        <FaLock className={loginStyles.inputIcon} />
                        <input type={showPassword ? 'text' : 'password'} name='password' value={formData.password} onChange={handleChange} placeholder='Password' required className={loginStyles.passwordInput} />
                    ...
                    <div className={loginStyles.rememberContainer}>
                        <label className={loginStyles.rememberLabel}>
                            <input type="checkbox" name='remember' checked={formData.remember} onChange={handleChange} className={loginStyles.rememberCheckbox} required />
                            Remember me
                        </label>
