...
import { FaFacebookF, FaTwitter, FaInstagram, FaYoutube, FaMapMarkedAlt, FaPhone, FaEnvelope, FaCcVisa, FaCcMastercard, FaCcPaypal, FaCcAmex, FaApplePay } from 'react-icons/fa';
                ...
                <div className={footerStyles.grid}>
                    ...
                    <div>
                        ...
                        <p className={footerStyles.brandText}>
                            Bringing you the freshest organic produce since 2026. Our mission is to deliver farm-fresh goodness straight to your doorsteps.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className={footerStyles.linkList}>
                            {['Home', 'Items', 'Contact'].map((item, idx) => (
                                <li key={idx} className={footerStyles.linkItem}>
                                    <a href={item === 'Home' ?
                                        '/' : `/${item.toLowerCase()}`}>
                ...
                <div className={footerStyles.attribution}>
                    <div className={footerStyles.attributionBadge}>
                        ...
                        <span className={footerStyles.attributionText}>
                            Designed By{' '}
                            <a href="https://tailwindcss.com/" target='_blank' className={footerStyles.attributionLink}>
                                TAILWIND CSS
                            </a>
                        </span>
                    </div>
...
/* key={idx}
React needs a unique indentifier for each item in a list 
idx = index
Helps React track which item is which when re-rendering(React updating the UI when data changes)
